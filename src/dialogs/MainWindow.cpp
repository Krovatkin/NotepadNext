    ...
    zoomEventWatcher(new ZoomEventWatcher(this))
{
    ...
    connect(ui->actionAboutNotepadNext, &QAction::triggered, this, [=]() {
        QMessageBox::about(this, QString(),
                            QStringLiteral("<h3>%1 v%2-%5 %3</h3>"
                                    "<p>%4</p>"
                                ...
                                .arg(QApplication::applicationDisplayName(), APP_VERSION, APP_DISTRIBUTION, QStringLiteral(APP_COPYRIGHT).toHtmlEscaped(), APP_GIT_HASH));
    });
